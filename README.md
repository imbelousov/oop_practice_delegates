...
сериализации, например, JSON и произвольный собственный формат. Организуйте код так, чтобы изменение
формата сериализации не требовало внесения изменений в исходный код класса `MessageEncoder`.
...
Вы можете воспользоваться готовыми реализациями в классах `AesHelper` и `DeflateHelper`.
