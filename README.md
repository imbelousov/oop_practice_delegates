...
Это p2p чат, использующий в качестве канала связи [named pipes](https://ru.wikipedia.org/wiki/%D0%98%D0%BC%D0%B5%D0%BD%D0%BE%D0%B2%D0%B0%D0%BD%D0%BD%D1%8B%D0%B9_%D0%BA%D0%B0%D0%BD%D0%B0%D0%BB). В проекте уже сделано низкоуровневое
...
Делегируйте сериализацию/десериализацию сериализатору! Реализуйте хотя бы два разных формата
сериализации, например, JSON и бинарную. Организуйте код так, чтобы изменение формата сериализации
